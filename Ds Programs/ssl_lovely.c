...
int main(){
	...
	do{
		...
		printf("\nPress 3 Insert Kth Position");
		printf("\nPress 4 for Insert before Specific value");
		printf("\nPress 5 for Insert after Specific value");
		printf("\nPress 6 for Delete Begining Node");
		printf("\nPress 7 for Delete End node");
		printf("\nPress 8 for Delete before Specific value");
		printf("\nPress 9 for Delete After Specific value");
		printf("\nPress 10 Delete Kth Position Node");
		printf("\nPress 11 Mean All Element");
		printf("\nPress 12 Standard deviation of all element");
		printf("\nPress 13 for Travese All Element");
		printf("\nPress 14 for Count nodes");
		printf("\nPress 15 for Max node value");
		printf("\nPress 16 for Exit");
		printf("\nPress one option: ");
		scanf("%d",&choice);
		switch(choice){
